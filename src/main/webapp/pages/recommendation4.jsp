...
<html>
    ...
    <body onLoad="activateItem(document.getElementById('menu5'))">
        <img id="topImage" src="<s:url value="4_Top.png"/>"/>
        
        <hr></hr>
        <div id="productHeader">Customer With Similar Fitness Goals Recently Viewed<br><br></div>
...
<hr></hr>
<img  id="bottomImage" src="<s:url value="4_Bottom.png"/>"/>
		<!-- </div> -->
