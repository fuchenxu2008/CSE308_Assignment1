...
<html>
    ...
    <body onLoad="activateItem(document.getElementById('menu6'))">
        <img id="topImage" src="<s:url value="6_Top.png"/>"/>
        
        <hr></hr>
        <div id="productHeader">Customer Who Bought This Also Bought<br><br></div>
...
<hr></hr>
<img  id="bottomImage" src="<s:url value="6_Bottom.png"/>"/>
		<!-- </div> -->
