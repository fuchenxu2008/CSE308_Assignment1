...
<html>
    ...
    <body onLoad="activateItem(document.getElementById('menu2'))">
        <img id="topImage" src="<s:url value="1_Top.png"/>"/>
        
        <hr></hr>
        <div id="productHeader">Recommendations for You<br><br></div>
...
<hr></hr>
<img  id="bottomImage" src="<s:url value="1_Bottom.png"/>"/>
		<!-- </div> -->
