...
<html>
    ...
    <body onLoad="activateItem(document.getElementById('menu3'))">
        <img id="topImage" src="<s:url value="3_Top.png"/>"/>
        
        <hr></hr>
        <div id="productHeader">Recommendations for You in Blood Pressure Products<br><br></div>
...
<hr></hr>
<img  id="bottomImage" src="<s:url value="3_Bottom.png"/>"/>
		<!-- </div> -->
