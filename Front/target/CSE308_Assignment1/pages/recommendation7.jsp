...
<html>
    ...
    <body onLoad="activateItem(document.getElementById('menu7'))">
        <img id="topImage" src="<s:url value="7_Top.png"/>"/>
        
        <hr></hr>
        <div id="productHeader">Most Popular Women's Care Products<br><br></div>
...
<hr></hr>
<img  id="bottomImage" src="<s:url value="7_Bottom.png"/>"/>
		<!-- </div> -->
